package com.daiban.oauth.config;


import com.daiban.oauth.util.UserJwt;
import com.daiban.pojo.feign.UserFeign;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        com.daiban.pojo.User user = userFeign.findUserInfo(username);
        //创建User对象
